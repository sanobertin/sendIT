...
var createtables=`CREATE TABLE IF NOT EXISTS  users(userID serial , name TEXT NOT NULL, email TEXT NOT NULL UNIQUE, username TEXT NOT NULL UNIQUE, pass TEXT NOT NULL, rights TEXT NOT NULL, date_created timestamp NOT NULL DEFAULT NOW(), PRIMARY KEY (userID) );
